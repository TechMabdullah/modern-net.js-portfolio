  ...
  return (
    <>
      <motion.div
        ...
        animate="animate"
        exit="exit"
        transition={{ duration: 0.4, duration: 0.6, ease: 'easeInOut' }}
      />
      ...
      <motion.div
        ...
        animate="animate"
        exit="exit"
        transition={{ duration: 0.6, duration: 0.8, ease: 'easeInOut' }}
      />
      ...
      <motion.div
        ...
        animate="animate"
        exit="exit"
        transition={{ duration: 0.8, duration: 1,ease: 'easeInOut' }}
      />
    </>
  );
};
